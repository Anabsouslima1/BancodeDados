...
-- Medicamento Testado 
INSERT INTO Medicamento_Testado (nome_produto, descricao, numero_lote, data_validade, data_fabricacao, id_farmacia, id_materia_prima, id_industria)
VALUES 
('FlexiVital', 'Suplemento alimentar indicado para melhorar a saúde das articulações, promover a saúde intestinal, aumentar a energia e melhorar a saúde geral da pele. Seu efeito sinérgico combina o poder do colágeno para articulações saudáveis, probióticos para digestão equilibrada, magnésio para uma musculatura forte, e ginseng para mais energia e resistência ao estresse diário. Ideal para quem busca uma abordagem natural para manter a saúde física e mental.', '19945', '2025-12-31', '2020-01-10', 2, 1, 3),
('Bemzilax', 'Suplemento nutricional indicado para auxiliar no equilíbrio intestinal, melhorar a absorção de ferro e promover o bem-estar digestivo. Sua fórmula combina fibra de carbono para promover a saúde intestinal, Escherichia coli (em uma cepa benéfica) para reequilibrar a flora intestinal e combater a disbiose, sulfato de ferro para prevenir a anemia e camomila para aliviar o desconforto gástrico. Ideal para quem busca melhorar a digestão, fortalecer o sistema imunológico e manter níveis saudáveis de ferro no organismo.', '67890', '2024-06-30', '2018-02-15', 1, 2, 2),
('DigestCare', 'Antibiótico para tratamento de infecções gastrointestinais e alívio de distúrbios digestivos como azia, refluxo e gastrite. A combinação de Streptomyces ajuda no combate de infecções bacterianas no trato gastrointestinal, enquanto o Carbonato de Cálcio e a Hortelã-pimenta promovem alívio para sintomas de azia, refluxo e cólicas. A Quitosana auxilia na redução do inchaço e proteção da mucosa gástrica, proporcionando alívio imediato e promovendo a recuperação digestiva.', '84465', '2026-03-31', '2023-12-10', 3, 3, 1),
('ArthroRelief', 'Anti-inflamatório e regenerador para o alívio de dores articulares e inflamações musculares. A pectina contribui para a recuperação das articulações, ajudando na mobilidade, enquanto o Bacillus subtilis tem efeito imunomodulador, promovendo a defesa contra inflamações crônicas. Indicado para condições como artrite, tendinite e lesões musculares.', '57683', '2026-11-30', '2024-05-10', 3, 4, 3),  
('ImunoCure', 'Antibiótico e anti-inflamatório para o tratamento de infecções bacterianas e alívio de inflamações. O sulfato de magnésio atua na regulação do sistema nervoso e muscular, e a cúrcuma fornece potentes propriedades anti-inflamatórias, sendo eficaz no tratamento de inflamações crônicas e lesões musculares. Ideal para o combate a infecções e fortalecimento do sistema imunológico.', '89234', '2025-09-30', '2023-11-22', 2, 5, 1);
